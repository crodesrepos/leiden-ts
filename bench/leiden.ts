/**
 * Full Leiden pipeline benchmark — Cat-4 Budget per docs/test-philosophy.md.
 * Runs leiden() end-to-end on synthetic ER graphs; asserts against
 * bench/baselines.json; exits non-zero on regression.
 */
...
function main(): number {
  ...
  console.log(
    `\n# leiden-ts full pipeline benchmark — ${new Date().toISOString()}\n`,
  );
  console.log(
